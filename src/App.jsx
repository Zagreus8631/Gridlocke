          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,80px)" }}>
            {grid.map((cell, i) => (
              <div
                ...
                onClick={() => {
  if (cell) {
    // GANZES POKEMON entfernen (nicht nur 1 Feld!)
    const id = cell.id;
    ...
    <div style={{ fontSize: 8 }}>{cell.nickname}</div>
        ...
        <div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(2,1fr)" }}>
            <div key={p.id} draggable onDragStart={() => setDragging(p)} style={{ marginBottom: 10 }}>
      ...
      {patternModal && (
        <div style={{
          ...
          <div style={{ background: "white", padding: 20 }}>
            ...
            <button onClick={() => setPatternModal(null)}>Abbrechen</button>
          </div>
        </div>
      )}
    </div>
